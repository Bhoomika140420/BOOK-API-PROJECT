...
const BookModel = require("./database/books"); //importimg db frm mongoDB Collections
...
app.get("/book/:isbn", async (req,res) => {
    ...
    // console.log(isbn);
    const getSpecificBook = await BookModel.find(db.books.filter((book) => book.ISBN === isbn));
