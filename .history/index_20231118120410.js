...
const uri = "mongodb+srv://bhoo1504:<ukchill06>@cluster0.elxc8v6.mongodb.net/book-company?retryWrites=true&w=majority";
// Create a MongoClient with a MongoClientOptions object to set the Stable API version
const client = new MongoClient(uri,{ useNewUrlParser: true, useUnifiedTopology: true});
client.connect(err => {
    const bcollection = client.db("book-company").collection("books"); //its array of objects
