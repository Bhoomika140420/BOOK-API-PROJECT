...
// var mangoDB = `mongodb+srv://${username}:${password}@${clusterURL}/${dbName}?retryWrites=true&w=majority`;
// mongoose.connect(mangoDB, {strict: true,deprecationErrors: true }).then(()=>console.log("CONNECTION ESTABLISHED"));
...
const client = new MongoClient(uri, {
   ...
   client.connect(err => {
    const bcollection = client.db("book-company").collection("books").findOne({ISBN: "12345Four"});
    console.log(bcollection.then((data)=>console.log(data)).catch((err)=>console.log(err)));
   });
