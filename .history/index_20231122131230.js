...
app.put("/book-update/:isbn", async (req,res) => {
    ...
    // console.log(req.params);
    const {isbn} = req.params;
    const updateBook = await BookModel.findOneAndupdateOne({ISBN: isbn}, req.body, {new: true});  //use mongoose model methods , mongoDB models doesn't work. create() works and insert() doesn't work
