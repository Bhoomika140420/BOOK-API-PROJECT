...
const db = require("./database"); //import index of db 
...
// // Set up default mongoose connection 
 var mongoDB = "mongodb+srv://bhoo1504:ukchill06@cluster0.elxc8v6.mongodb.net/book-company?retryWrites=true&w=majority";
 mongoose.connect(mongoDB,strict,true,deprecationErrors,true).then(()=>console.log("CONNECTION ESTABLISHED"));
